...
search_url = 'http://www.jzggzy.com.1399981940.proxy.jingzhou.gov.cn/jydt/003001/003001001/moreinfo3.html'


# 抓取的网站信息
# 荆州市公共资源交易中心
# http://www.jzggzy.com.1399981940.proxy.jingzhou.gov.cn/jydt/003001/003001001/moreinfo3.html
...
def content(bid_url):
    ...
    # print(page_text1)
    page_text = soup.select('.news-article-para')
    ...
    bid_money = re.findall('总投资额.*?(\d+\.?\d+[万]?)', page_text)                # 招标金额
    if not bid_money:
    ...
    customer_phone = re.findall('联系电话.*?(\d+-?\d+)', page_text)          # 客户联系方式
...
def r_quests(crux_list, increment=0):
    ...
    """
    global set_url
    main_url = 'http://www.jzggzy.com'

    # 采购公告
    cg_url_one = 'http://www.jzggzy.com.1399981940.proxy.jingzhou.gov.cn/jydt/003001/003001001/moreinfo3.html'
    cg_url_two = 'http://www.jzggzy.com.1399981940.proxy.jingzhou.gov.cn/jydt/003001/003001002/moreinfo3.html'
    cg_url = 'http://www.jzggzy.com.1399981940.proxy.jingzhou.gov.cn/jydt/003001/003001001/{}.html'
    cg_url2 = 'http://www.jzggzy.com.1399981940.proxy.jingzhou.gov.cn/jydt/003001/003001002//{}.html'
    def get_etree(c_url):
    ...
    def handle(cg1,cg2):
        ...
        while sign:
            ...
            for r_i in range(1, 21):
                ...
                b_title = tree.xpath(f'/html/body/div[2]/div[2]/div[2]/div[2]/div/div/div[2]/ul/li[{r_i}]/a/text()')  # 招标标题
                if not b_title:
                    sign = False
                    return
                    ...
                    for crux_i in crux_list:
                        ...
                        # print(b_title)
                        continue
                b_release = tree.xpath(f'/html/body/div[2]/div[2]/div[2]/div[2]/div/div/div[2]/ul/li[{r_i}]/span/text()')  # 发标日期
                b_release = b_release[0].strip()
                b_url = tree.xpath(f'/html/body/div[2]/div[2]/div[2]/div[2]/div/div/div[2]/ul/li[{r_i}]/a/@href')  # 网页链接地址
    ...
    handle(cg_url_two, cg_url2)
# 房投·春风里勘察、基坑支护设计及基坑监测项目报建公告(项目编号JZSJ-202106FJ-039/


def main5():
    global set_url
    a = Bidding.objects.filter(collect_id=12).all().values_list('b_url')
...
# content('http://www.jzggzy.com/jydt/003001/003001002/20200428/69b72d0e-4b4b-48f8-a883-ccff641a96fd.html')