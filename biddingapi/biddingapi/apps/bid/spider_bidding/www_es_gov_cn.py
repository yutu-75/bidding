...
search_url = 'http://www.es.gov.cn/xxgk/gkml/zbcg/index.shtml'


# 抓取的网站信息
# 恩施政府采购
# http://www.es.gov.cn/xxgk/gkml/zbcg/
...
def r_quests(crux_list, increment=0):
    ...
    """
    global set_url
    main_url = 'http://www.es.gov.cn'

    # 采购公告
    cg_url_one = 'http://www.es.gov.cn/xxgk/gkml/zbcg/index.shtml'
    cg_url = 'http://www.es.gov.cn/xxgk/gkml/zbcg/index_{}.shtml'
    ...
    def handle(cg1,cg2):
        ...
        while sign:
            ...
            for r_i in range(1, 21):
                ...
                b_title = tree.xpath(f'/html/body/div/div[2]/div/div[2]/div[2]/div/div[1]/ul/li[{r_i}]/a/text()')  # 招标标题
                                      # '/html/body/div/div[2]/div/div[2]/div[2]/div/div[1]/ul/li[21]/a/text()'
                if not b_title:
                    print('wwwww',r_i)
                    sign = False
                    ...
                    if crux_list != 1:
                        for crux_i in crux_list:
                            ...
                            # print(b_title)
                            continue
                b_release = tree.xpath(f'/html/body/div/div[2]/div/div[2]/div[2]/div/div[1]/ul/li[{r_i}]/a/span/text()')  # 发标日期
                b_release = b_release[0].strip()
                b_url = tree.xpath(f'/html/body/div/div[2]/div/div[2]/div[2]/div/div[1]/ul/li[{r_i}]/a/@href')  # 网页链接地址
...
def main10():
    global set_url
    a = Bidding.objects.filter(collect_id=14).all().values_list('b_url')
...
# u2 = 'http://www.es.gov.cn/xxgk/gkml/zbcg/201908/t20190808_418239.shtml'
# content(u2)